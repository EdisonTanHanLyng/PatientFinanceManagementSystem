...
document.querySelector('.sidebar_body_account').addEventListener('click', function () {
    const accountList = document.querySelector('.sidebar_inner_list');
    const toggleIcon = document.querySelector('.material-symbols-outlined.icon-small');
...
document.querySelector('.sidebar_body_create_account_text').addEventListener('click', function (e) {
    e.preventDefault();
    window.location.href = '/AccountCreate/AccountCreate';
});
...
document.querySelector('.sidebar_body_management_account_text').addEventListener('click', function (e) {
    e.preventDefault();
