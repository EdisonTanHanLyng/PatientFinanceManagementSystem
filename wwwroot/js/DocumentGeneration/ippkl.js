...
document.getElementById('generateExcelButton').addEventListener('click', function (e) {
    ...
    let totalMedicine = parseFloat(document.getElementById('totalSuntikan').innerText);
    ...
    fetch('/DocumentGen/GenerateIPPKL', {
        method: 'POST',
        headers: {
...
// Function to recalculate the overall totals when any Kos Rawatan or Kos Suntikan value changes
function recalculateTotal() {
    ...
    overallTotal += overallTotalRawatan + overallTotalSuntikan;
...
document.querySelectorAll(`input[name^="kosRawatan"], input[name^="kosSuntikan"]`).forEach(input => {
...
function confirmSelection() {
    sessionStorage.setItem("currentSponsor", "PDRM");
    sessionStorage.setItem("currentPage", "IPPKL");
